...
type
  TMediaType = (MediaTypeJson, MediaTypeXml);

  TMediaTypes = set of TMediaType;

const
  cMediaTypeStr: array[MediaTypeJson..MediaTypeXml] of string = (RestUtils.MediaType_Json, RestUtils.MediaType_Xml);
  LOCALE_RUSSIAN = 'ru-RU';
  LOCALE_US = 'en-US';
